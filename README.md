...
⚠️ **Atenção**: Isso irá deletar todas as tabelas DynamoDB e seus dados!
...
3. **Pagamentos**
   ...
   - Sistema de depósito e caução

4. **Busca Avançada**
   - Implementar ElasticSearch
   - Filtros e ordenação complexa
...
**Desenvolvido com ❤️ usando Serverless Framework e AWS**